        ...
        <div className="article">
            ...
            <div className="section">
                <div className="text">
                    ...
                    <p>I’ve always been the ‘tech guy’ at my respective places of employment.  Additionally, in the past 18 months I have completed the Front End Web Development (HTML, CSS, JavaScript), Python/SQL, and React.js courses offered by Code Louisville.  I have supported the CFA Communications Manager with the Community Farm Alliance web page, including inserting an interactive map on the Farmers Market Support Program page, and setting up landing pages and registrations for CFA and FMSP Events.  I’ve also volunteered time and web development support to Louisville New Roots, the Louisville Community Grocery, and recently began volunteering with <a class="inline-link" target="_blank" rel="noopener noreferrer" href='https://thefarmboard.com/'>The Farm Board</a>, a web based project to connect buyers with what’s in season on participating farms.</p>
