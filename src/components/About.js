    ...
    return (
        <div className="article">
            ...
            <div className="section">
                <div className="text">
                    <p>I am pursuing new opportunities in the food industry that can better utilize my digital and web skillset.  For the past 5 years, I have been Kentucky’s statewide Farmers Market Support Program Manager with Community Farm Alliance.  In February of 2015, I inherited a program with 15 participating markets, a paper application process, and a basic and unambitious structure for the year.  Since then, I’ve developed the ‘Farmer’s Market Matters’ webinar series, an online annual application process, created networking spaces for Kentucky Farmers market leaders online, and have grown the program to support 58 Farmers Markets (just over 1/3 of all registered markets in KY), with a team of 4 additional part-time regional staff providing technical support. And on the side, I spearheaded the passage of House Bill 468, which expanded the list of allowable items that could be sold to the public from home kitchens.  Like you, I have also concluded that utilizing and embracing technology is an essential ingredient for small and medium farms to not only compete with ‘Big Ag’, but to work towards reversing the trend of ever-shrinking profit margins.  </p>
