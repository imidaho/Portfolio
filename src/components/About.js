    ...
    return (
        <div className="article">
            ...
            <div className="section">
                <div className="text">
                    <p>I am pursuing new career opportunities that can better utilize my digital and web skillset.  For the past 5 years, I have been Kentucky’s statewide Farmers Market Support Program Manager with Community Farm Alliance.  In February of 2015, I inherited a program with 15 participating markets, a paper application process, and a basic and unambitious structure for the year.  Since then, I developed the <a class="inline-link" target="_blank" rel="noopener noreferrer" href='https://www.youtube.com/playlist?list=PLpn7g4wm9pMLC0bYiyll1R3tTKoTH3tr0'>‘Farmer’s Market Matters’ webinar series</a>, an online annual application process, created networking spaces for Kentucky Farmers market leaders online, and have grown the program to support 58 Farmers Markets (just over 1/3 of all registered markets in KY), with a team of 4 additional part-time regional staff providing technical support. And on the side, I spearheaded the passage of House Bill 468, which expanded the list of allowable items that could be sold to the public from home kitchens.</p>
                    <p>I’ve always been the ‘tech guy’ at my respective places of employment.  Additionally, in the past 18 months I have completed the Front End Web Development (HTML, CSS, JavaScript), Python/SQL, and React.js courses offered by <a class="inline-link" target="_blank" rel="noopener noreferrer" href='https://codelouisville.org/'>Code Louisville</a>.  I have supported the CFA Communications Manager with the Community Farm Alliance web page, including inserting an interactive map on the Farmers Market Support Program page, and setting up landing pages and registrations for CFA and FMSP Events.  I’ve also volunteered time and web development support to Louisville New Roots, the Louisville Community Grocery, and recently began volunteering with <a class="inline-link" target="_blank" rel="noopener noreferrer" href='https://thefarmboard.com/'>The Farm Board</a>, a web based project to connect buyers with what’s in season on participating farms.</p>
